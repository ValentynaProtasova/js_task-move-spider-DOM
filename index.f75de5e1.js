...
document.addEventListener("click", (e)=>{
    ...
    const centerX = Math.max(spiderWidth / 2, Math.min(clickCenterX, wallWidth - spiderWidth / 2));
    const centerY = Math.max(spiderHeight / 2, Math.min(clickCenterY, wallHeight - spiderHeight / 2));
